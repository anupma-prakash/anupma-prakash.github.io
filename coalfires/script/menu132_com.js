...
function OpenMenu(){
	//document.mainphoto.src='images/index_mainphoto_dark.png';
	if(MaskHeaderPhoto==1)document.getElementById("photo_mask").style.visibility='visible';
	if(Ldd&&Crtd){
...
function ChangePhoto() {
	// document.mainphoto.src='images/index_mainphoto2.jpg';
	if(MaskHeaderPhoto==1)document.getElementById("photo_mask").style.visibility='hidden';}
...
function CloseMenu(){
	if(Ldd&&Crtd){
		...
		if(this==CurOvr){
			...
			IniFlg=true;CloseTmr=setTimeout("Initiate(CurOvr)",DissapearDelay);CloseTmr=setTimeout("ChangePhoto()",DissapearDelay*5)}}}
